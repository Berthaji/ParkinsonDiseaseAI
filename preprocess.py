...
def flip_and_save_image(image, save_path):
    ...
    @param image: L'immagine da flippare.
    @param save_path: Percorso dove salvare l'immagine nuova.
    """
...
def preprocess_images(input_dir, rotation_angles=[90, 180, 270], num_rotations=2, apply_flip=True):
    """
    ...
    for class_folder in os.listdir(input_dir):
        ...
        if os.path.isdir(class_folder_path):
            # Scorre tutte le immagini nella cartella
            for image_name in os.listdir(class_folder_path):
                ...
                if os.path.isfile(image_path):
                    ...
                    for _ in range(num_rotations):
                        # Seleziona un angolo di rotazione casuale
                        ...
                        # Salva l'immagine ruotata nella cartella 
